...
class Usuario extends Authenticatable
{
    ...
    protected $fillable = [
        'tenant_id', 'pessoa_id', 'nome', 'login', 'email', 'cargo', 'password', 'perfil', 'telefone', 'ativo', 'ultimo_acesso',
    ...
    protected $hidden = ['password', 'remember_token', 'master_2fa_secret', 'master_2fa_recovery_codes'];
    ...
    protected $casts = [
        ...
        'master_2fa_recovery_codes' => 'array',
    ];
