    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hamburger {
            ...
            font-size: 22px; color: var(--primary); padding: 4px 8px;
        }
        ...
        input, select, textarea {
            ...
            background: var(--white); font-family: inherit; transition: border-color .2s;
        }
...
<div class="layout">
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="nav-group">
            ...
            <a href="{{ route('relatorios.index') }}" class="nav-item {{ $rota === 'relatorios.index' ? 'active' : '' }}">
...
<script>
    ...
    // Mostra nome no topbar em telas maiores
    function checkWidth() {
        const username = document.querySelector('.topbar-username');
        if (username) username.style.display = window.innerWidth > 480 ? 'inline' : 'none';
    }
    checkWidth();
