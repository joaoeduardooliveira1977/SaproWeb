...
<head>
    ...
    <meta name="application-name" content="Software Jurídico">
...
<nav class="nav-drawer" id="navDrawer">
    ...
    <a href="{{ route('cadastros.hub') }}" class="nav-drawer-item {{ $hubAtivo==='cadastros' ? 'active' : '' }}" onclick="toggleDrawer()">
    ...
    @endif
    @if($isAdmin)
    <a href="{{ route('configuracoes.escritorio') }}" class="nav-drawer-item {{ $rota==='configuracoes.escritorio' ? 'active' : '' }}" onclick="toggleDrawer()">
...
<nav class="sidebar">
    ...
    <a href="{{ route('cadastros.hub') }}" class="nav-btn {{ $hubAtivo==='cadastros' ? 'active' : '' }}" title="Cadastros">
    ...
    @if($isAdmin)
    <a href="{{ route('configuracoes.escritorio') }}" class="nav-btn {{ $rota==='configuracoes.escritorio' ? 'active' : '' }}" title="Configurações">
...
<nav class="bottom-nav" aria-label="Navegação principal">
    <div class="bottom-nav-inner">
        <a href="{{ route('dashboard') }}" class="{{ $rota==='dashboard' ? 'active' : '' }}">
            <svg viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
            Início
        </a>
        ...
        <a href="{{ route('prazos') }}" class="{{ $rota==='prazos' ? 'active' : '' }}" style="position:relative;">
            <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
            Prazos
            @if($prazosHoje > 0)
            <span class="badge">{{ $prazosHoje }}</span>
            @endif
        </a>
        <a href="{{ route('agenda') }}" class="{{ $rota==='agenda' ? 'active' : '' }}">
            <svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
            Agenda
        </a>
        <a href="{{ route('financeiro') }}" class="{{ in_array($rota, ['financeiro','honorarios','inadimplencia']) ? 'active' : '' }}">
