            ...
            <div style="padding:20px;overflow-y:auto;border-right:1px solid var(--border);">
                ...
                <div style="display:flex;gap:8px;flex-wrap:wrap;justify-content:space-between;margin-top:4px;">
                    <div style="display:flex;gap:8px;">
                        ...
                        <a href="{{ route('orcamentos') }}?crm={{ $opId }}"
                           style="display:inline-flex;align-items:center;gap:5px;font-size:12px;padding:6px 12px;border-radius:7px;background:#f0f9ff;color:#0891b2;border:1.5px solid #bae6fd;text-decoration:none;font-weight:600;">
                            <svg aria-hidden="true" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                            Gerar proposta
                        </a>
