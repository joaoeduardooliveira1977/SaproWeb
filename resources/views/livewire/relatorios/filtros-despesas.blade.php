<div style="max-width:520px;margin:0 auto;">
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
        ...
        <div>
            ...
            <p style="font-size:12px;color:#64748b;margin:0;">Selecione o cliente e o período para gerar o PDF</p>
        </div>
    </div>
    ...
    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:16px;padding:28px;">
        ...
        <button wire:click="gerar" wire:loading.attr="disabled"
            ...
            <span wire:loading.remove wire:target="gerar">📥 Gerar Relatório PDF</span>
