...
<div class="card">
    <div class="card-header">
        <span class="card-title" style="display:flex;align-items:center;gap:7px;">
            <svg aria-hidden="true" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>
            Mercado Financeiro
        ...
        <div style="display:flex;align-items:center;gap:8px;">
            ...
            @endif
            <button wire:click="refresh" class="btn btn-secondary btn-sm" title="Atualizar" style="display:inline-flex;align-items:center;justify-content:center;">
                <span wire:loading.remove wire:target="refresh" style="display:inline-flex;"><svg aria-hidden="true" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-4.51"/></svg></span>
                <span wire:loading wire:target="refresh" class="mf-spin" style="display:inline-flex;"><svg aria-hidden="true" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-4.51"/></svg></span>
            </button>
        </div>
    </div>
    ...
    @if($erro)
        <p style="color:#dc2626;font-size:13px;text-align:center;padding:24px 0;display:flex;flex-direction:column;align-items:center;gap:6px;">
            <svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#dc2626" stroke-width="2"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
            Não foi possível carregar os dados do mercado.<br>
    ...
    <div style="display:flex;flex-direction:column;gap:8px;">
        ...
        <div style="padding:10px 14px;border-radius:8px;background:{{ $bg }};border:1px solid {{ $brd }};">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:8px;">
                <div style="width:36px;height:36px;border-radius:8px;background:{{ $bg }};border:1px solid {{ $brd }};display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                    <span style="font-size:10px;font-weight:800;color:{{ $cor }};">{{ $m['sigla'] }}</span>
                </div>
