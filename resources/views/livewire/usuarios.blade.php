            ...
            <tr style="border-bottom:1px solid var(--border);"
                ...
                <td style="padding:10px 12px;text-align:center;">
                    <button wire:click="toggleAtivo({{ $u->id }})"
                        style="background:{{ $u->ativo ? '#dcfce7' : '#fee2e2' }};color:{{ $u->ativo ? '#16a34a' : '#dc2626' }};border:none;padding:3px 12px;border-radius:12px;font-size:11px;font-weight:700;cursor:pointer;">
