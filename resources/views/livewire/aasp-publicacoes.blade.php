...
@if($aba === 'publicacoes')
    ...
    <div class="stats-row">
        ...
        <div class="stat-card" style="border-left-color: var(--accent);">
            <div class="stat-icon"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></div>
            <div class="stat-val">{{ $advogados->where('ativo', true)->count() }}</div>
            <div class="stat-label">Advogados ativos</div>
        </div>
        <div class="stat-card" style="border-left-color: var(--success);">
            <div class="stat-icon"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg></div>
    ...
    <div class="card mb-4">
        ...
        <div class="action-bar">
            ...
            <button class="btn btn-primary" wire:click="buscarPublicacoes" wire:loading.attr="disabled">
                ...
                <span wire:loading wire:target="buscarPublicacoes" style="display:inline-flex;align-items:center;gap:6px;"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg> Buscando…</span>
            </button>
        </div>
    ...
    <div class="action-bar">
        ...
        @if(count($publicacoes) > 0)
            <button class="btn btn-success btn-sm" wire:click="gerarPdf" wire:loading.attr="disabled">
                ...
                <span wire:loading wire:target="gerarPdf" style="display:inline-flex;align-items:center;gap:6px;"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg> Gerando…</span>
            </button>
            <button class="btn btn-primary btn-sm" wire:click="enviarEmail" wire:loading.attr="disabled"
                ...
                <span wire:loading wire:target="enviarEmail" style="display:inline-flex;align-items:center;gap:6px;"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg> Enviando…</span>
            </button>
        @endif
    </div>
