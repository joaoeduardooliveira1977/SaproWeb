        ...
        <div style="padding:24px;">
            ...
            <div style="background:#f8fafc;border:1.5px solid var(--border);border-radius:10px;padding:14px;margin-bottom:10px;">
                <div style="display:flex;align-items:center;gap:8px;margin-bottom:10px;">
                    ...
                    @if($acao['tipo'])
                    <button wire:click="preencherConfigPadrao({{ $ai }})" title="Preencher config padrão"
                ...
                <div>
                    ...
                    <textarea wire:model="acoes.{{ $ai }}.config_json" rows="4"
                        style="width:100%;padding:10px 12px;border:1.5px solid var(--border);border-radius:8px;font-size:12px;font-family:monospace;color:var(--text);background:var(--white);resize:vertical;box-sizing:border-box;line-height:1.5;">{{ $acao['config_json'] }}</textarea>
                </div>
            </div>
            @endforeach
