@extends('layouts.app')
@section('page-title', 'Relatório de Despesas por Cliente')
@section('content')
<div style="max-width:520px;margin:0 auto;">
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
        ...
        <div>
            <h1 style="font-size:20px;font-weight:800;color:#0f2540;margin:0;">Relatório de Despesas por Cliente</h1>
            <p style="font-size:12px;color:#64748b;margin:0;">Selecione os filtros e gere o PDF</p>
        </div>
    </div>
    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:16px;padding:28px;">
        <form method="GET" action="{{ route('relatorios.despesas.pdf') }}" target="_blank">
