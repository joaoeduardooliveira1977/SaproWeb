...
<div style="display:grid;grid-template-columns:1fr 276px;gap:18px;align-items:start;" class="dash-layout">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:14px;" class="dash-kpis">
            ...
            <a href="<?php echo e(route('processos')); ?>" style="text-decoration:none;">
                <div style="background:#fff;border-radius:12px;border:1px solid #e2e8f0;padding:16px;position:relative;overflow:hidden;transition:transform .15s,box-shadow .15s;cursor:pointer;"
                    ...
                    <div style="font-size:24px;font-weight:800;color:#1e3a8a;letter-spacing:-1px;"><?php echo e($totalProcessos); ?></div>
            ...
            <a href="<?php echo e(route('prazos')); ?>" style="text-decoration:none;">
                <div style="background:#fff;border-radius:12px;border:1px solid #e2e8f0;padding:16px;position:relative;overflow:hidden;transition:transform .15s,box-shadow .15s;cursor:pointer;"
                    onmouseover="this.style.transform='translateY(-2px)';this.style.boxShadow='0 4px 16px rgba(0,0,0,.08)'"
                    onmouseout="this.style.transform='';this.style.boxShadow=''">
                    ...
                    <div style="font-size:24px;font-weight:800;color:#dc2626;letter-spacing:-1px;"><?php echo e($prazosHoje); ?></div>
            ...
            <a href="<?php echo e(route('financeiro')); ?>" style="text-decoration:none;">
                <div style="background:#fff;border-radius:12px;border:1px solid #e2e8f0;padding:16px;position:relative;overflow:hidden;transition:transform .15s,box-shadow .15s;cursor:pointer;"
                    ...
                    <?php $recStr = number_format((float)$totalReceber, 0, ',', '.'); $recFs = strlen($recStr) > 8 ? '17' : '24'; ?>
            ...
            <a href="<?php echo e(route('processos')); ?>" style="text-decoration:none;">
                <div style="background:#fff;border-radius:12px;border:1px solid #e2e8f0;padding:16px;position:relative;overflow:hidden;transition:transform .15s,box-shadow .15s;cursor:pointer;"
                    ...
                    <div style="font-size:24px;font-weight:800;color:#065f46;letter-spacing:-1px;"><?php echo e($andamentosHoje); ?></div>
        ...
        <div style="background:#fff;border-radius:14px;border:1px solid #e2e8f0;padding:20px;">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
                ...
                <div style="display:flex;align-items:center;gap:8px;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($acoesUrgentes) > 0): ?>
                    <span style="padding:3px 10px;background:#fee2e2;color:#dc2626;border-radius:20px;font-size:11px;font-weight:700;"><?php echo e(count($acoesUrgentes)); ?> alerta<?php echo e(count($acoesUrgentes) > 1 ? 's' : ''); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <a href="<?php echo e(route('prazos')); ?>" style="font-size:12px;font-weight:700;color:#1D9E75;text-decoration:none;padding:5px 12px;background:#f0fdf4;border-radius:7px;border:1px solid #bbf7d0;">Ver todos</a>
                </div>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $acoesUrgentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prazo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            <div style="display:flex;align-items:center;gap:12px;padding:11px 12px;border-radius:10px;border:1px solid #f1f5f9;margin-bottom:8px;transition:background .15s;"
                ...
                <span style="font-size:12px;font-weight:700;color:#2563eb;white-space:nowrap;min-width:36px;text-align:center;"><?php echo e($hora); ?></span>
                <div style="width:4px;height:36px;border-radius:3px;background:<?php echo e($cor); ?>;flex-shrink:0;"></div>
                <div style="flex:1;min-width:0;">
                    <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
                        <span style="font-size:13px;font-weight:700;color:#1e293b;"><?php echo e(Str::limit($prazo->titulo, 48)); ?></span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prazo->prazo_fatal): ?><span style="padding:1px 6px;background:#fef2f2;color:#dc2626;border-radius:4px;font-size:10px;font-weight:700;">FATAL</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <div style="font-size:11px;color:#64748b;margin-top:2px;">
                        <?php echo e($prazo->processo?->numero ?? '—'); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prazo->processo?->cliente): ?> · <?php echo e(Str::limit($prazo->processo->cliente->nome, 28)); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                <span style="padding:3px 8px;background:<?php echo e($bgCor); ?>;color:<?php echo e($cor); ?>;border-radius:5px;font-size:10px;font-weight:700;flex-shrink:0;"><?php echo e($badge); ?></span>
                <a href="<?php echo e(route('processos.show', $prazo->processo_id)); ?>"
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;" class="dash-charts">
            ...
            <div style="background:#fff;border-radius:14px;border:1px solid #e2e8f0;padding:18px;">
                ...
                <div style="position:relative;height:180px;display:flex;align-items:center;justify-content:center;">
                    ...
                    <?php $total3 = $criticos + $atencao + $normais; $pctOk = $total3 > 0 ? round($normais / $total3 * 100) : 0; ?>
                    <div style="position:absolute;text-align:center;pointer-events:none;">
                        <div style="font-size:20px;font-weight:800;color:#1e293b;"><?php echo e($pctOk); ?>%</div>
                ...
                <div style="display:flex;justify-content:center;gap:14px;margin-top:12px;flex-wrap:wrap;">
                    <span style="display:flex;align-items:center;gap:5px;font-size:11px;color:#64748b;"><span style="width:10px;height:10px;border-radius:50%;background:#ef4444;display:inline-block;"></span>Críticos (<?php echo e($criticos); ?>)</span>
                    <span style="display:flex;align-items:center;gap:5px;font-size:11px;color:#64748b;"><span style="width:10px;height:10px;border-radius:50%;background:#f59e0b;display:inline-block;"></span>Atenção (<?php echo e($atencao); ?>)</span>
                    <span style="display:flex;align-items:center;gap:5px;font-size:11px;color:#64748b;"><span style="width:10px;height:10px;border-radius:50%;background:#10b981;display:inline-block;"></span>Saudáveis (<?php echo e($normais); ?>)</span>
                </div>
            </div>
            ...
            <div style="display:flex;gap:12px;padding:10px 0;border-bottom:1px solid #f1f5f9;">
                ...
                <div style="flex:1;min-width:0;">
                    <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-bottom:3px;">
                        <span style="font-size:12px;font-weight:700;color:#1e293b;"><?php echo e($and->numero ?? '—'); ?></span>
    ...
    <div style="display:flex;flex-direction:column;gap:14px;">
        ...
        <div style="background:#fff;border-radius:14px;border:1px solid #e2e8f0;padding:18px;">
            ...
            <div style="display:flex;gap:10px;padding:10px;border-radius:9px;background:<?php echo e($ins['bg']); ?>;margin-bottom:8px;">
                <div style="width:4px;border-radius:3px;background:<?php echo e($ins['cor']); ?>;flex-shrink:0;"></div>
                <div>
                    <div style="font-size:12px;font-weight:700;color:#1e293b;"><?php echo e($ins['titulo']); ?></div>
                    <div style="font-size:11px;color:#64748b;margin-top:2px;line-height:1.4;"><?php echo e($ins['sub']); ?></div>
                </div>
            </div>
        ...
        <div style="background:#fff;border-radius:14px;border:1px solid #e2e8f0;padding:18px;">
            ...
            <div style="display:flex;gap:10px;padding:9px 0;border-bottom:1px solid #f1f5f9;">
                <span style="font-size:12px;font-weight:700;color:#1D9E75;white-space:nowrap;padding-top:1px;min-width:38px;"><?php echo e($ev->data_hora->format('H:i')); ?></span>
                <div style="min-width:0;flex:1;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ev->tipo): ?><div style="font-size:11px;color:#94a3b8;margin-top:2px;"><?php echo e($ev->tipo); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ev->local): ?> · <?php echo e($ev->local); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
