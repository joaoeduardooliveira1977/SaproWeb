...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:12px;margin-bottom:20px;">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $config; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tabela => $cfg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <button wire:click="abrirTabela('<?php echo e($tabela); ?>')"
        style="text-align:left;padding:18px 20px;border-radius:12px;border:2px solid <?php echo e($tabelaAtiva === $tabela ? 'var(--primary-light)' : 'transparent'); ?>;background:<?php echo e($tabelaAtiva === $tabela ? '#eff6ff' : 'var(--white)'); ?>;box-shadow:0 1px 3px rgba(0,0,0,.08);cursor:pointer;transition:all .15s;width:100%;"
        onmouseover="if('<?php echo e($tabela); ?>' !== '<?php echo e($tabelaAtiva); ?>') { this.style.borderColor='var(--border)'; }"
        onmouseout="if('<?php echo e($tabela); ?>' !== '<?php echo e($tabelaAtiva); ?>') { this.style.borderColor='transparent'; }">
        <div style="width:40px;height:40px;border-radius:10px;background:<?php echo e($bgs[$tabela] ?? '#f1f5f9'); ?>;display:flex;align-items:center;justify-content:center;margin-bottom:10px;">
            <?php echo $icons[$tabela] ?? ''; ?>

        </div>
        <div style="font-weight:600;color:<?php echo e($tabelaAtiva === $tabela ? 'var(--primary-light)' : 'var(--text)'); ?>;font-size:14px;margin-bottom:3px;">
            <?php echo e($cfg['label']); ?>

        </div>
        <div style="font-size:12px;color:var(--muted);"><?php echo e($contagens[$tabela]); ?> registros</div>
    </button>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>


<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tabelaAtiva && isset($config[$tabelaAtiva])): ?>
<?php $cfg = $config[$tabelaAtiva]; ?>
<div class="card" style="padding:0;overflow:hidden;">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;padding:16px 20px;border-bottom:1px solid var(--border);background:var(--bg);">
        <div style="font-weight:700;font-size:15px;color:var(--text);"><?php echo e($cfg['label']); ?></div>
        ...
        <table style="border-collapse:collapse;width:100%;">
            <thead>
                <tr style="border-bottom:1px solid var(--border);">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cfg['temOrdem'] ?? false): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cfg['temCor'] ?? false): ?>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cfg['temAtivo'] ?? false): ?>
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $registros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr style="border-bottom:1px solid var(--border);transition:background .15s;" onmouseover="this.style.background='var(--bg)'" onmouseout="this.style.background=''">
                    <td style="padding:12px 16px;font-size:12px;color:var(--muted);font-family:monospace;"><?php echo e($row->codigo ?? '—'); ?></td>
                    <td style="padding:12px 16px;font-size:13px;font-weight:500;color:var(--text);"><?php echo e($row->descricao); ?></td>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cfg['temOrdem'] ?? false): ?>
                    <td style="padding:12px 16px;text-align:center;font-size:13px;color:var(--muted);"><?php echo e($row->ordem ?? '—'); ?></td>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cfg['temCor'] ?? false): ?>
                    <td style="padding:12px 16px;text-align:center;">
                        <span style="display:inline-block;width:22px;height:22px;border-radius:50%;background:<?php echo e($row->cor_hex); ?>;border:2px solid #fff;box-shadow:0 0 0 1px #cbd5e1;" title="<?php echo e($row->cor_hex); ?>"></span>
                    </td>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cfg['temAtivo'] ?? false): ?>
                    <td style="padding:12px 16px;text-align:center;">
                        <button wire:click="toggleAtivo(<?php echo e($row->id); ?>)" title="<?php echo e($row->ativo ? 'Desativar' : 'Ativar'); ?>"
                            style="padding:3px 10px;border-radius:20px;border:none;cursor:pointer;font-size:11px;font-weight:600;
                                background:<?php echo e($row->ativo ? '#dcfce7' : '#f1f5f9'); ?>;
                                color:<?php echo e($row->ativo ? '#16a34a' : '#94a3b8'); ?>;">
                            <?php echo e($row->ativo ? 'Ativo' : 'Inativo'); ?>
                    ...
                    <td style="padding:12px 16px;text-align:center;">
                        <div style="display:flex;align-items:center;justify-content:center;gap:5px;">
                            <button wire:click="abrirModal(<?php echo e($row->id); ?>)" title="Editar"
                            ...
                            <button wire:click="excluir(<?php echo e($row->id); ?>)"
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modal && $tabelaAtiva): ?>
<?php $cfg = $config[$tabelaAtiva]; ?>
    ...
    <div style="background:var(--white);border-radius:12px;width:100%;max-width:420px;box-shadow:0 20px 60px rgba(0,0,0,.25);overflow:hidden;">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;padding:18px 22px;border-bottom:1px solid var(--border);">
            <h3 style="font-size:15px;font-weight:700;color:var(--text);margin:0;">
                <?php echo e($registroId ? 'Editar' : 'Adicionar'); ?> — <?php echo e($cfg['label']); ?>
        ...
        <div style="padding:20px 22px;display:flex;flex-direction:column;gap:14px;">
            ...
            <div>
                ...
                <input type="text" wire:model="descricao" placeholder="Nome do registro..."
                    style="width:100%;padding:8px 12px;border:1.5px solid <?php echo e($errors->has('descricao') ? 'var(--danger)' : 'var(--border)'); ?>;border-radius:8px;font-size:13px;background:var(--white);color:var(--text);">
...
$message = $__bag->first($__errorArgs[0]); ?> <p style="font-size:11px;color:var(--danger);margin-top:4px;"><?php echo e($message); ?></p> <?php unset($message);
...
<?php /**PATH C:\projetos\saproweb-base\resources\views/livewire/tabelas-dominio.blade.php ENDPATH**/ ?>