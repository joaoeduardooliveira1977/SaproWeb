...
<body>
<?php if (isset($component)) { $__componentOriginal38762e60b008342ec819128f7e52e63f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal38762e60b008342ec819128f7e52e63f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.limite-plano','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('limite-plano'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal38762e60b008342ec819128f7e52e63f)): ?>
<?php $attributes = $__attributesOriginal38762e60b008342ec819128f7e52e63f; ?>
<?php unset($__attributesOriginal38762e60b008342ec819128f7e52e63f); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal38762e60b008342ec819128f7e52e63f)): ?>
<?php $component = $__componentOriginal38762e60b008342ec819128f7e52e63f; ?>
<?php unset($__componentOriginal38762e60b008342ec819128f7e52e63f); ?>
<?php endif; ?>
<div id="lw-bar"></div>
<div class="layout">
...
<nav class="nav-drawer" id="navDrawer">
    <a href="<?php echo e(route('dashboard')); ?>" class="nav-drawer-item <?php echo e($rota==='dashboard' ? 'active' : ''); ?>" onclick="toggleDrawer()">
    ...
    <a href="<?php echo e(route('financeiro.hub')); ?>" class="nav-drawer-item <?php echo e($hubAtivo==='financeiro' ? 'active' : ''); ?>" onclick="toggleDrawer()">
    ...
    <a href="<?php echo e(route('admin.hub')); ?>" class="nav-drawer-item <?php echo e($hubAtivo==='admin' ? 'active' : ''); ?>" onclick="toggleDrawer()">
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAdmin): ?>
    <a href="<?php echo e(route('configuracoes.escritorio')); ?>" class="nav-drawer-item <?php echo e($rota==='configuracoes.escritorio' ? 'active' : ''); ?>" onclick="toggleDrawer()">
        <svg viewBox="0 0 24 24"><path d="M12.22 2h-.44a2 2 0 00-2 2v.18a2 2 0 01-1 1.73l-.43.25a2 2 0 01-2 0l-.15-.08a2 2 0 00-2.73.73l-.22.38a2 2 0 00.73 2.73l.15.1a2 2 0 011 1.72v.51a2 2 0 01-1 1.74l-.15.09a2 2 0 00-.73 2.73l.22.38a2 2 0 002.73.73l.15-.08a2 2 0 012 0l.43.25a2 2 0 011 1.73V20a2 2 0 002 2h.44a2 2 0 002-2v-.18a2 2 0 011-1.73l.43-.25a2 2 0 012 0l.15.08a2 2 0 002.73-.73l.22-.39a2 2 0 00-.73-2.73l-.15-.08a2 2 0 01-1-1.74v-.5a2 2 0 011-1.74l.15-.09a2 2 0 00.73-2.73l-.22-.38a2 2 0 00-2.73-.73l-.15.08a2 2 0 01-2 0l-.43-.25a2 2 0 01-1-1.73V4a2 2 0 00-2-2z"/><circle cx="12" cy="12" r="3"/></svg>Configurações
    </a>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <a href="<?php echo e(route('minha-conta')); ?>" class="nav-drawer-item <?php echo e($rota==='minha-conta' ? 'active' : ''); ?>" onclick="toggleDrawer()">
        <svg viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>Conta
    </a>
    <form action="<?php echo e(route('logout')); ?>" method="POST" style="margin:0;"><?php echo csrf_field(); ?>
...
<nav class="sidebar">
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="nav-btn <?php echo e($rota==='dashboard' ? 'active' : ''); ?>" title="Início">
        <svg viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
        <span class="nav-btn-label">Início</span>
    </a>

    <a href="<?php echo e(route('processos.hub')); ?>" class="nav-btn <?php echo e($hubAtivo==='processos' ? 'active' : ''); ?>" title="Processos">
    ...
    <a href="<?php echo e(route('prazos')); ?>" class="nav-btn <?php echo e($rota==='prazos' ? 'active' : ''); ?>" title="Prazos">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prazosHoje>0): ?><span class="nav-badge"><?php echo e($prazosHoje > 9 ? '9+' : $prazosHoje); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </a>

    <a href="<?php echo e(route('agenda')); ?>" class="nav-btn <?php echo e($rota==='agenda' ? 'active' : ''); ?>" title="Agenda">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFinanc): ?>
    <a href="<?php echo e(route('financeiro.hub')); ?>" class="nav-btn <?php echo e($hubAtivo==='financeiro' ? 'active' : ''); ?>" title="Financeiro">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAdmin): ?>
    <a href="<?php echo e(route('admin.hub')); ?>" class="nav-btn <?php echo e($hubAtivo==='admin' ? 'active' : ''); ?>" title="Administração">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAdmin): ?>
    <a href="<?php echo e(route('configuracoes.escritorio')); ?>" class="nav-btn <?php echo e($rota==='configuracoes.escritorio' ? 'active' : ''); ?>" title="Configurações">
        ...
        <span class="nav-btn-label">Config.</span>
    </a>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <a href="<?php echo e(route('minha-conta')); ?>" class="nav-btn <?php echo e($rota==='minha-conta' ? 'active' : ''); ?>" title="Minha Conta">
    ...
    <div class="main">
        <div class="topbar">
            ...
            <span class="topbar-title" style="flex-shrink:0;"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></span>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canProc): ?>
	...
	<div class="quick-add" id="quickAdd">
                ...
                <div class="quick-add-menu" id="quickAddMenu">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canProc): ?>
                    <a href="<?php echo e(route('processos')); ?>" class="quick-add-item">
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canPessoas): ?>
                    <a href="<?php echo e(route('pessoas')); ?>" class="quick-add-item">
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canAgenda): ?>
                    <div class="quick-add-sep"></div>
                    <a href="<?php echo e(route('prazos')); ?>" class="quick-add-item">
                    ...
                    <a href="<?php echo e(route('audiencias')); ?>" class="quick-add-item">
...
[$__name, $__params] = $__split('busca-global');

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-357889760-0', $__key);
...
[$__name, $__params] = $__split('notificacoes-bell');

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-357889760-1', $__key);
...
if (isset($__slots)) unset($__slots);
?>
                <div class="avatar"><?php echo e(strtoupper(substr(auth('usuarios')->user()?->nome ?? 'U', 0, 2))); ?></div>
                <span style="display:none" class="topbar-username"><?php echo e(auth('usuarios')->user()?->nome); ?></span>
            </div>
        </div>
...
<?php /**PATH C:\projetos\saproweb-base\resources\views/layouts/app.blade.php ENDPATH**/ ?>