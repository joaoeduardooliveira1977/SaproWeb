<?php $__env->startSection('page-title', 'Central de Administração'); ?>
...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;flex-wrap:wrap;gap:12px;">
    ...
    <div style="display:flex;gap:10px;">
        <a href="<?php echo e(route('usuarios')); ?>"
        ...
        <a href="<?php echo e(route('auditoria')); ?>"
...
<div class="hub-kpis" style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-bottom:20px;">
    ...
    <a href="<?php echo e($k['route']); ?>" style="text-decoration:none;">
        <div style="background:<?php echo e($k['bg']); ?>;border-radius:14px;padding:22px 20px;color:#fff;cursor:pointer;transition:transform .15s,box-shadow .15s;box-shadow:0 4px 15px rgba(0,0,0,.15);"
            ...
            <div style="font-size:28px;font-weight:800;margin-bottom:4px;letter-spacing:-1px;"><?php echo e($k['val']); ?></div>
    ...
    <div style="display:flex;align-items:flex-start;gap:16px;">
        ...
        <div style="flex:1;">
            ...
            <div style="font-size:13px;color:var(--muted);line-height:1.7;">
                Sistema operando normalmente com <strong style="color:var(--primary);"><?php echo e($totalUsuarios); ?> usuário(s) ativo(s)</strong>
                e <strong style="color:#7c3aed;"><?php echo e($totalClientes); ?> cliente(s)</strong> cadastrado(s).
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($portalAtivos > 0): ?>
                    <strong style="color:#059669;"><?php echo e($portalAtivos); ?> cliente(s)</strong> com acesso ao portal ativo.
            ...
            <div style="display:flex;flex-wrap:wrap;gap:16px;margin-top:12px;font-size:12px;color:var(--muted);">
                <span style="display:flex;align-items:center;gap:5px;">
                    ...
                    <strong style="color:#2563a8;"><?php echo e($totalUsuarios); ?></strong>&nbsp;usuários ativos
                </span>
                <span style="display:flex;align-items:center;gap:5px;">
                    <svg width="8" height="8" viewBox="0 0 24 24" fill="#7c3aed" stroke="none"><circle cx="12" cy="12" r="10"/></svg>
                    <strong style="color:#7c3aed;"><?php echo e($totalClientes); ?></strong>&nbsp;clientes
                </span>
                <span style="display:flex;align-items:center;gap:5px;">
                    <svg width="8" height="8" viewBox="0 0 24 24" fill="#059669" stroke="none"><circle cx="12" cy="12" r="10"/></svg>
                    <strong style="color:#059669;"><?php echo e($portalAtivos); ?></strong>&nbsp;no portal
                </span>
                <span style="display:flex;align-items:center;gap:5px;">
                    <svg width="8" height="8" viewBox="0 0 24 24" fill="#475569" stroke="none"><circle cx="12" cy="12" r="10"/></svg>
                    <strong style="color:#475569;"><?php echo e($totalAuditoria); ?></strong>&nbsp;ações hoje
                </span>
            </div>
        </div>
    </div>
...
<div style="background:var(--white);border:1.5px solid var(--border);border-radius:12px;padding:20px;">
    ...
    <div class="hub-modulos" style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;">
        ...
        <a href="<?php echo e($m['route']); ?>" style="text-decoration:none;">
            <div style="display:flex;align-items:center;gap:12px;padding:16px;border-radius:12px;background:<?php echo e($m['bg']); ?>;border:1.5px solid <?php echo e($m['cor']); ?>22;transition:all .15s;cursor:pointer;"
                onmouseover="this.style.borderColor='<?php echo e($m['cor']); ?>';this.style.transform='translateY(-2px)';this.style.boxShadow='0 4px 12px rgba(0,0,0,.08)'"
                onmouseout="this.style.borderColor='<?php echo e($m['cor']); ?>22';this.style.transform='';this.style.boxShadow=''">
                <div style="width:40px;height:40px;border-radius:10px;background:#fff;color:<?php echo e($m['cor']); ?>;display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 2px 8px rgba(0,0,0,.08);">
                    <?php echo $m['svg']; ?>

                </div>
                <div>
                    <div style="font-size:13px;font-weight:700;color:<?php echo e($m['cor']); ?>;"><?php echo e($m['label']); ?></div>
                    <div style="font-size:11px;color:var(--muted);margin-top:2px;"><?php echo e($m['desc']); ?></div>
                </div>
            </div>
        </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projetos\saproweb-base\resources\views/hubs/admin.blade.php ENDPATH**/ ?>