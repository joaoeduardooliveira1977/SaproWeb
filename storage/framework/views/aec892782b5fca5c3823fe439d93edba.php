<?php $__env->startSection('page-title', 'Preview Dashboard'); ?>
...
<div class="preview-board">
    <section class="preview-hero">
        <div class="preview-hero-copy">
            ...
            <div class="preview-hero-actions">
                <a href="<?php echo e(route('dashboard')); ?>" class="preview-btn preview-btn-primary">Voltar ao dashboard atual</a>
                <a href="<?php echo e(route('prazos')); ?>" class="preview-btn preview-btn-secondary">Abrir prazos</a>
            </div>
        </div>
    ...
    <section class="preview-kpis">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $kpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kpi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <article class="preview-kpi tone-<?php echo e($kpi['tone']); ?>">
                <span><?php echo e($kpi['label']); ?></span>
                <strong><?php echo e($kpi['value']); ?></strong>
                <small><?php echo e($kpi['meta']); ?></small>
            </article>
    ...
    <section class="preview-grid">
                ...
                <div class="preview-timeline">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $timeline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="preview-timeline-item">
                            <span class="preview-time"><?php echo e($item['time']); ?></span>
                            <div class="preview-timeline-body">
                                <strong><?php echo e($item['title']); ?></strong>
                                <small><?php echo e($item['tag']); ?></small>
                            </div>
                            <span class="preview-chip tone-<?php echo e($item['tone']); ?>"><?php echo e($item['tag']); ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </article>
            ...
            <div class="preview-analytics">
                ...
                <article class="preview-card preview-bars-card">
                    ...
                    <div class="preview-bars">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="preview-bar-col">
                                <div class="preview-bar" style="height: <?php echo e($bar['value']); ?>%;"></div>
                                <span><?php echo e($bar['label']); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </article>
        ...
        <aside class="preview-side">
            <article class="preview-card preview-ai-card">
                ...
                <a href="<?php echo e(route('assistente')); ?>" class="preview-btn preview-btn-dark">Analisar com IA</a>
            </article>
            ...
            <article class="preview-card">
                ...
                <div class="preview-watchlist">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $watchlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $watch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="preview-watch-item">
                            <strong><?php echo e($watch['title']); ?></strong>
                            <small><?php echo e($watch['copy']); ?></small>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </article>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projetos\saproweb-base\resources\views/dashboard-preview.blade.php ENDPATH**/ ?>